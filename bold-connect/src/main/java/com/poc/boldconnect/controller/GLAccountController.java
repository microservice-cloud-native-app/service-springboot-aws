...
public class GLAccountController {
    ...
    @Autowired
    public GLAccountController(LedgerGLAccountDelegate LedgerGLAccountDelegate, RestTemplate restTemplate) {
    ...
    public ResponseEntity<?> lookupAccounts(@RequestHeader(value = "uuid", required = true) String uuid,
        ...
        System.err.println(restTemplate.getForEntity("http://google.com",String.class));
