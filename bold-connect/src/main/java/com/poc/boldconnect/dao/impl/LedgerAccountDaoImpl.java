    ...
    public void saveAccounts(List<Account> accounts) {
        ...
        for (Account account : accounts) {
            Item item = new Item()
                    ...
                    .withString("accountSubType",account.getAccountSubType())
